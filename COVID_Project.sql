...
-- Data was split into two seperate tables using Excel (COVID deaths and subsequent information and COVID vaccinations and subsequent information)

-- Begin by checking that data was uploaded correctly
Select * 
